...
test("init copies config + scripts and is idempotent", () => {
  ...
  try {
    ...
    assert.ok(existsSync(join(dest, "CLAUDE.md")), "CLAUDE.md generated by gen-rules");
    assert.ok(existsSync(join(dest, ".cursorrules")), ".cursorrules generated by gen-rules");
